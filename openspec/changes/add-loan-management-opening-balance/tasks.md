...
- [ ] 返済取引を作成してTagAssignmentを追加し、再度テスト
...
- [ ] Chrome DevTools Networkタブで `/api/report` のレスポンスタイムを計測
- [ ] 目標: 1秒以内
- [ ] Chrome DevTools Performanceタブでグリッド描画時間を計測
- [ ] 目標: 1秒以内
- [ ] 問題がある場合は最適化を実施:
  - インデックス追加
  - クエリ最適化
